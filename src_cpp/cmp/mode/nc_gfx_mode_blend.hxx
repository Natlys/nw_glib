#ifndef NC_GFX_MODE_BLENDING_H
#define NC_GFX_MODE_BLENDING_H
...
namespace NC
{
    /// graphics_state_blending_type
    class gfx_state_blend_t : public nc_cmp_tt<gfx_state_blend_t>, public gfx_mode_t
    {
    public:
        using blend_t = gfx_state_blend_t;
