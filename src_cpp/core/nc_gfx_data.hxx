#ifndef NC_GFX_DATA_H
#define NC_GFX_DATA_H
#include "nc_gfx_core.hpp"
#if (defined NC_GAPI)
// vertex
namespace NC
{
	static inline v1f_t vtx_quad_2f[] = {
		-1.0f,	-1.0f, // lt-bt
		-1.0f,	+1.0f, // lt-tp
		+1.0f,	+1.0f, // rt-tp
		+1.0f,	-1.0f, // rt-bt
	};
	static inline v1f_t vtx_quad_2f2f[] = {
	-1.0f,	-1.0f,	0.00f,	0.00f,	// lt-bt
	-1.0f,	+1.0f,	0.00f,	1.00f,	// lt-tp
	+1.0f,	+1.0f,	1.00f,	1.00f,	// rt-tp
	+1.0f,	-1.0f,	1.00f,	0.00f,	// rt-bt
	};
	static inline const v1f_t vtx_quad_3f2f3f[] = {
	...
	static inline const v1f_t vtx_cube_3f[] = {
		// lt
		-1.0f, -1.0f,  1.0f,
		-1.0f, -1.0f, -1.0f,
		-1.0f,  1.0f, -1.0f,
	...
	static inline const v1f_t vtx_cube_3f2f3f[] = {
		// lt
...
namespace NC
{
	static inline const v1u_t idx_quad[] = {
		// lt-bt -> lt-tp -> rt-tp
		0u, 1u, 2u,
		// rt-tp -> rt-bt -> lt-bt
		2u, 3u, 0u,
	};
	static inline const v1u_t idx_cube[] = {
		// lt
		0u + 0u,	0u + 1u,	0u + 2u,
		0u + 2u,	0u + 3u,	0u + 0u,
		// rt
...
namespace NC
{
	static inline const v1u08_t txr_pixels[] = {
		0u,		128u,	0u,		255u,
		0u,		0u,		128u,	255u,
		0u,		0u,		128u,	255u,
		0u,		128u,	0u,		255u,
