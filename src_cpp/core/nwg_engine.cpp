...
namespace NWG
{
	GfxEngine::GfxEngine(HWND pWindow) :
		m_gInfo(GfxContextInfo()), m_gConfig(GfxConfig()),
		m_pWindow(pWindow),
		m_pDevice(nullptr), m_pContext(nullptr)
	{
		...
		m_pContext = OglNewContext(m_pDevice);
		OglMakeContextCurr(m_pDevice, m_pContext);
		OglClose();
	...
	void GfxEngine::Update()
	{
		...
		OglBegin(GL_QUADS);
		OglVertex2f32(-0.25f, -0.25f);
		OglColor4ui8(128u, 128u, 0u, 128u);
		OglVertex2f32(-0.25f, 0.25f);
		OglColor4ui8(128u, 0u, 128u, 128u);
		OglVertex2f32(0.25f, 0.25f);
		OglColor4ui8(128u, 128u, 0u, 128u);
		OglVertex2f32(0.25f, -0.25f);
		OglColor4ui8(128u, 0u, 128u, 128u);
	...
	void GfxEngine::OnDraw(ADrawCmp& rDrb)
	{
		rDrb.OnDraw();
	}
