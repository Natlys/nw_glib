#ifndef NW_GFX_DATA_HPP
#define NW_GFX_DATA_HPP
...
namespace NW
{
	static inline const darray<v1u8> txr_pixels = {
		0u,		128u,	0u,		255u,
		0u,		0u,		128u,	255u,
		0u,		0u,		128u,	255u,
		0u,		128u,	0u,		255u,
...
void main()
{
	...
	vso.nrm_crd = vec3(cst_model * vec4(vsi_nrm_crd, 1.0f));
}
)";
