#ifndef NWGFX_FRAMEBUFFER_H
#define NWGFX_FRAMEBUFFER_H
...
namespace NWGFX
{
	...
	public:
		...
		inline v1s get_size_x() const      { return m_size.x; }
		inline v1s get_size_y() const      { return m_size.y; }
