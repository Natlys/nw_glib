...
typedef void (APIENTRYP PFNGLCLEARTEXIMAGE) (GLuint tex_id, GLint level, GLenum format, GLenum type, const void* data);
extern PFNGLCLEARTEXIMAGE OglClearTexImage;
