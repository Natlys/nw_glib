...
namespace NW
{
	bit gfx_load_fmbuf() {
		...
		// attachments
		glFramebufferTexture1D = (pfn_ogl_fmbuf_txr1d)(gfx_get_proc("glFramebufferTexture1D"));
		glFramebufferTexture2D = (pfn_ogl_fmbuf_txr2d)(gfx_get_proc("glFramebufferTexture2D"));
		glFramebufferTexture3D = (pfn_ogl_fmbuf_txr3d)(gfx_get_proc("glFramebufferTexture3D"));
		// draw and read
...
namespace NW
{
	...
	// attachments
	pfn_ogl_fmbuf_txr1d glFramebufferTexture1D = NULL;
	pfn_ogl_fmbuf_txr2d glFramebufferTexture2D = NULL;
	pfn_ogl_fmbuf_txr3d glFramebufferTexture3D = NULL;
	// draw and read
