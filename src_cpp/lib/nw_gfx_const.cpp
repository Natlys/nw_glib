...
namespace NW
{
	template<> value_types convert<const GLchar*, value_types>(const GLchar* type_string) {
		// value 8 bit boolean
		if      (strcmp(type_string, "bool") == 0)  { return NW_GET_VTYPE_ENUM_S(VTYPE_V1_BIT); }
		else if (strcmp(type_string, "bvec2") == 0) { return NW_GET_VTYPE_ENUM_S(VTYPE_V2_BIT); }
		else if (strcmp(type_string, "bvec3") == 0) { return NW_GET_VTYPE_ENUM_S(VTYPE_V3_BIT); }
		else if (strcmp(type_string, "bvec4") == 0) { return NW_GET_VTYPE_ENUM_S(VTYPE_V4_BIT); }
		// value 32 bit signed integer
		if      (strcmp(type_string, "int") == 0)   { return NW_GET_VTYPE_ENUM_D(VTYPE_V1_S32); }
		else if (strcmp(type_string, "ivec2") == 0) { return NW_GET_VTYPE_ENUM_D(VTYPE_V2_S32); }
		else if (strcmp(type_string, "ivec3") == 0) { return NW_GET_VTYPE_ENUM_D(VTYPE_V3_S32); }
		else if (strcmp(type_string, "ivec4") == 0) { return NW_GET_VTYPE_ENUM_D(VTYPE_V4_S32); }
		// value 32 bit unsigned integer
		if      (strcmp(type_string, "uint") == 0)  { return NW_GET_VTYPE_ENUM_D(VTYPE_V4_U32); }
		else if (strcmp(type_string, "uvec2") == 0) { return NW_GET_VTYPE_ENUM_D(VTYPE_V4_U32); }
		else if (strcmp(type_string, "uvec3") == 0) { return NW_GET_VTYPE_ENUM_D(VTYPE_V4_U32); }
		else if (strcmp(type_string, "uvec4") == 0) { return NW_GET_VTYPE_ENUM_D(VTYPE_V4_U32); }
		// value 32 bit float
		if      (strcmp(type_string, "float") == 0) { return NW_GET_VTYPE_ENUM_D(VTYPE_V1_F32); }
		else if (strcmp(type_string, "vec2") == 0)  { return NW_GET_VTYPE_ENUM_D(VTYPE_V2_F32); }
		else if (strcmp(type_string, "vec3") == 0)  { return NW_GET_VTYPE_ENUM_D(VTYPE_V3_F32); }
		else if (strcmp(type_string, "vec4") == 0)  { return NW_GET_VTYPE_ENUM_D(VTYPE_V4_F32); }
		// value 64 bit float
		if      (strcmp(type_string, "double") == 0) { return NW_GET_VTYPE_ENUM_D(VTYPE_V1_F64); }
		else if (strcmp(type_string, "dvec2") == 0)  { return NW_GET_VTYPE_ENUM_D(VTYPE_V2_F64); }
		else if (strcmp(type_string, "dvec3") == 0)  { return NW_GET_VTYPE_ENUM_D(VTYPE_V3_F64); }
		else if (strcmp(type_string, "dvec4") == 0)  { return NW_GET_VTYPE_ENUM_D(VTYPE_V4_F64); }
		// value sampler
		if      (strcmp(type_string, "sampler1D") == 0) { return NW_GET_VTYPE_ENUM_D(VTYPE_DEFAULT); }
		else if (strcmp(type_string, "sampler2D") == 0) { return NW_GET_VTYPE_ENUM_D(VTYPE_DEFAULT); }
		else if (strcmp(type_string, "sampler3D") == 0) { return NW_GET_VTYPE_ENUM_D(VTYPE_DEFAULT); }
