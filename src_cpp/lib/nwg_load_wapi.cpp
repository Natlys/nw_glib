...
namespace NW
{
	...
	bit gfx_ext_has_support(cstr extension_name) { return strstr(wglGetExtensionsStringEXT(), extension_name) != NULL; }
	
	bit gfx_ext_load_wapi()
	{
...
namespace NW
{
	...
	bit gfx_ext_has_support(cstr extension_name) { return FALSE; }
