#ifndef NWG_OGL_NATIVE_H
#define NWG_OGL_NATIVE_H
#ifndef __gl_h_	// default opengl header macro
#define __gl_h_
#include <stddef.h>
// base ogl types
...
#ifndef NWG_OGL_MACRO
#define NWG_OGL_MACRO 1
