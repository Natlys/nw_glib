...
namespace NWG
{
	void OglLoadArb()
	{
		...
		OglGetActiveAtomicCounterefferiv = (PFNGLGETACTIVEATOMICCOUNTERBUFFERIVPROC)OglGetProc("glGetActiveAtomicCounterefferiv");
		...
		OglClearefferData = (PFNGLCLEARBUFFERDATAPROC)OglGetProc("glClearefferData");
		OglClearefferSubData = (PFNGLCLEARBUFFERSUBDATAPROC)OglGetProc("glClearefferSubData");
...
PFNGLGETACTIVEATOMICCOUNTERBUFFERIVPROC OglGetActiveAtomicCounterefferiv;
...
PFNGLCLEARBUFFERDATAPROC OglClearefferData;
PFNGLCLEARBUFFERSUBDATAPROC OglClearefferSubData;
