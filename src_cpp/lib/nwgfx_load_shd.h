#ifndef NWGFX_LOAD_SHADER_H
#define NWGFX_LOAD_SHADER_H
...
namespace NWGFX
{
	...
	// predicates
	typedef GLboolean (APIENTRYP pfn_ogl_shd_is_shader)    (GLuint shd_id);
}
namespace NWGFX
{
	// general
...
namespace NWGFX
{
	typedef HRESULT (APIENTRYP pfn_gfx_shd_compile)
