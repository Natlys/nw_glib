#ifndef NWGFX_LOAD_SAMPLER_H
#define NWGFX_LOAD_SAMPLER_H
...
namespace NWGFX
{
	...
	typedef void (APIENTRYP pfn_ogl_smp_bind) (GLuint gfx_txrunit, GLuint sampler_id);
	// params
