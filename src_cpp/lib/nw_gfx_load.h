#ifndef NW_GFX_LOAD_H
#define NW_GFX_LOAD_H
...
namespace NW
{
	...
	public:
		...
		// --getters
		inline v1u get_ver_num() const      { return m_ver_num; }
		inline v1u get_ver_major() const    { return (m_ver_num / 100); }
		inline v1u get_ver_minor() const    { return (m_ver_num / 10) % 10; }
		...
		inline v1u get_max_slot_atb() const { return m_max_slot_atb; }
		inline v1u get_max_slot_txr() const { return m_max_slot_txr; }
		// --predicates
		inline bool has_support(v1u major, v1u minor) const {
