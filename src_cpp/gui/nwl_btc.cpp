#include <nwg_pch.hpp>
#define NWL_BIN_TO_COMP
#undef NWL_BIN_TO_COMP
#if (defined NWL_BIN_TO_COMP)
// dear imgui
...
// Load compressed TTF fonts with GUI::GetIO().Fonts->AddFontFromMemoryCompressedTTF()
