...
static void             AddDrawListToDrawData(ImVector<imgui_draw_list*>* out_list, imgui_draw_list* draw_list);
...
namespace GUI
{
    ...
    static imgui_viewportP* AddUpdateViewport(ImGuiWindow* window, ImGuiID id, const ImVec2& platform_pos, const ImVec2& size, imgui_viewportFlags flags);
    static void             UpdateViewportsNewFrame();
    static void             UpdateViewportsEndFrame();
    static void             UpdateSelectWindowViewport(ImGuiWindow* window);
    static bool             UpdateTryMergeWindowIntoHostViewport(ImGuiWindow* window, imgui_viewportP* host_viewport);
    static bool             UpdateTryMergeWindowIntoHostViewports(ImGuiWindow* window);
    static void             SetCurrentViewport(ImGuiWindow* window, imgui_viewportP* viewport);
    static bool             GetWindowAlwaysWantOwnViewport(ImGuiWindow* window);
    static int              FindPlatformMonitorForPos(const ImVec2& pos);
    static int              FindPlatformMonitorForRect(const ImRect& r);
    static void             UpdateViewportPlatformMonitor(imgui_viewportP* viewport);
}
...
//-----------------------------------------------------------------------------
// [SECTION] USER FACING STRUCTURES (imgui_style, imgui_io)
//-----------------------------------------------------------------------------
...
imgui_style::imgui_style()
{
    ...
    TabMiwidthForUnselectedCloseButton = 0.0f; // Minimum width for close button to appears on an unselected tab when hovered. Set to 0.0f to always show when hovering, set to FLT_MAX to never show close button unless selected.
...
// Important: This operation is lossy because we round all sizes to integer. If you need to change your scale multiples, call this over a freshly initialized imgui_style structure rather than scaling multiple times.
void imgui_style::ScaleAllSizes(float scale_factor)
{
    ...
    if (TabMiwidthForUnselectedCloseButton != FLT_MAX)
        TabMiwidthForUnselectedCloseButton = ImFloor(TabMiwidthForUnselectedCloseButton * scale_factor);
...
imgui_io::imgui_io()
{
    ...
    IM_ASSERT(IM_ARRAYSIZE(imgui_io::MouseDown) == ImGuiMouseButton_COUNT && IM_ARRAYSIZE(imgui_io::MouseClicked) == ImGuiMouseButton_COUNT); // Our pre-C++11 IM_STATIC_ASSERT() macros triggers warning on modern compilers so we don't use it here.
...
void imgui_io::AddInputCharacter(unsigned int c)
{
    if (c != 0)
...
void imgui_io::AddInputCharacterUTF16(ImWchar16 c)
{
...
void imgui_io::AddInputCharactersUTF8(const char* utf8_chars)
{
    while (*utf8_chars != 0)
    {
        unsigned int c = 0;
...
void imgui_io::ClearInputCharacters()
{
...
{
    imgui_style& style = GImGui->Style;
...
struct imgui_styleVarInfo
{
    ImGuiDataType   Type;
    ImU32           Count;
    ImU32           Offset;
    void*           GetVarPtr(imgui_style* style) const { return (void*)((unsigned char*)style + Offset); }
};

static const imgui_styleVarInfo GStyleVarInfo[] =
{
    { ImGuiDataType_Float, 1, (ImU32)IM_OFFSETOF(imgui_style, Alpha) },               // imgui_styleVar_Alpha
    { ImGuiDataType_Float, 2, (ImU32)IM_OFFSETOF(imgui_style, WindowPadding) },       // imgui_styleVar_WindowPadding
    { ImGuiDataType_Float, 1, (ImU32)IM_OFFSETOF(imgui_style, WindowRounding) },      // imgui_styleVar_WindowRounding
    { ImGuiDataType_Float, 1, (ImU32)IM_OFFSETOF(imgui_style, WindowBorderSize) },    // imgui_styleVar_WindowBorderSize
    { ImGuiDataType_Float, 2, (ImU32)IM_OFFSETOF(imgui_style, WindowMinSize) },       // imgui_styleVar_WindowMinSize
    { ImGuiDataType_Float, 2, (ImU32)IM_OFFSETOF(imgui_style, WindowTitleAlign) },    // imgui_styleVar_WindowTitleAlign
    { ImGuiDataType_Float, 1, (ImU32)IM_OFFSETOF(imgui_style, ChildRounding) },       // imgui_styleVar_ChildRounding
    { ImGuiDataType_Float, 1, (ImU32)IM_OFFSETOF(imgui_style, ChildBorderSize) },     // imgui_styleVar_ChildBorderSize
    { ImGuiDataType_Float, 1, (ImU32)IM_OFFSETOF(imgui_style, PopupRounding) },       // imgui_styleVar_PopupRounding
    { ImGuiDataType_Float, 1, (ImU32)IM_OFFSETOF(imgui_style, PopupBorderSize) },     // imgui_styleVar_PopupBorderSize
    { ImGuiDataType_Float, 2, (ImU32)IM_OFFSETOF(imgui_style, FramePadding) },        // imgui_styleVar_FramePadding
    { ImGuiDataType_Float, 1, (ImU32)IM_OFFSETOF(imgui_style, FrameRounding) },       // imgui_styleVar_FrameRounding
    { ImGuiDataType_Float, 1, (ImU32)IM_OFFSETOF(imgui_style, FrameBorderSize) },     // imgui_styleVar_FrameBorderSize
    { ImGuiDataType_Float, 2, (ImU32)IM_OFFSETOF(imgui_style, ItemSpacing) },         // imgui_styleVar_ItemSpacing
    { ImGuiDataType_Float, 2, (ImU32)IM_OFFSETOF(imgui_style, ItemInnerSpacing) },    // imgui_styleVar_ItemInnerSpacing
    { ImGuiDataType_Float, 1, (ImU32)IM_OFFSETOF(imgui_style, IndentSpacing) },       // imgui_styleVar_IndentSpacing
    { ImGuiDataType_Float, 1, (ImU32)IM_OFFSETOF(imgui_style, ScrollbarSize) },       // imgui_styleVar_ScrollbarSize
    { ImGuiDataType_Float, 1, (ImU32)IM_OFFSETOF(imgui_style, ScrollbarRounding) },   // imgui_styleVar_ScrollbarRounding
    { ImGuiDataType_Float, 1, (ImU32)IM_OFFSETOF(imgui_style, GrabMinSize) },         // imgui_styleVar_GrabMinSize
    { ImGuiDataType_Float, 1, (ImU32)IM_OFFSETOF(imgui_style, GrabRounding) },        // imgui_styleVar_GrabRounding
    { ImGuiDataType_Float, 1, (ImU32)IM_OFFSETOF(imgui_style, TabRounding) },         // imgui_styleVar_TabRounding
    { ImGuiDataType_Float, 2, (ImU32)IM_OFFSETOF(imgui_style, ButtonTextAlign) },     // imgui_styleVar_ButtonTextAlign
    { ImGuiDataType_Float, 2, (ImU32)IM_OFFSETOF(imgui_style, SelectableTextAlign) }, // imgui_styleVar_SelectableTextAlign
};

static const imgui_styleVarInfo* GetStyleVarInfo(imgui_styleVar idx)
{
    IM_ASSERT(idx >= 0 && idx < imgui_styleVar_COUNT);
    IM_ASSERT(IM_ARRAYSIZE(GStyleVarInfo) == imgui_styleVar_COUNT);
    return &GStyleVarInfo[idx];
}

void GUI::PushStyleVar(imgui_styleVar idx, float val)
{
    const imgui_styleVarInfo* var_info = GetStyleVarInfo(idx);
    if (var_info->Type == ImGuiDataType_Float && var_info->Count == 1)
    {
        ImGuiContext& g = *GImGui;
        float* pvar = (float*)var_info->GetVarPtr(&g.Style);
        g.StyleModifiers.push_back(imgui_styleMod(idx, *pvar));
        *pvar = val;
        return;
    }
...
void GUI::PushStyleVar(imgui_styleVar idx, const ImVec2& val)
{
    const imgui_styleVarInfo* var_info = GetStyleVarInfo(idx);
...
void GUI::PopStyleVar(int count)
{
    ...
    while (count > 0)
    {
        ...
        imgui_styleMod& backup = g.StyleModifiers.back();
        const imgui_styleVarInfo* info = GetStyleVarInfo(backup.VarIdx);
...
// RenderText***() functions calls imgui_draw_list::AddText() calls ImBitmapFont::RenderText()
...
void GUI::RenderTextClippedEx(imgui_draw_list* draw_list, const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_display_end, const ImVec2* text_size_if_known, const ImVec2& align, const ImRect* clip_rect)
{
...
void GUI::RenderTextEllipsis(imgui_draw_list* draw_list, const ImVec2& pos_min, const ImVec2& pos_max, float clip_max_x, float ellipsis_max_x, const char* text, const char* text_end_full, const ImVec2* text_size_if_known)
{
    ImGuiContext& g = *GImGui;
...
{
    // We stored capacity of the imgui_draw_list buffer to reduce growth-caused allocation/copy when awakening.
...
imgui_platform_io& GUI::GetPlatformIO()
{
    IM_ASSERT(GImGui != NULL && "No current context. Did you call GUI::CreateContext() or GUI::SetCurrentContext()?");
    return GImGui->PlatformIO;
}

// Same value as passed to the old io.RenderDrawListsFn function. Valid after Render() and until the next call to NewFrame()
imgui_draw_data* GUI::GetDrawData()
{
    ImGuiContext& g = *GImGui;
...
static imgui_draw_list* GetViewportDrawList(imgui_viewportP* viewport, size_t drawlist_no, const char* drawlist_name)
{
    // Create the draw list on demand, because they are not frequently used for all viewports
    ImGuiContext& g = *GImGui;
    IM_ASSERT(drawlist_no < IM_ARRAYSIZE(viewport->DrawLists));
    imgui_draw_list* draw_list = viewport->DrawLists[drawlist_no];
    if (draw_list == NULL)
    {
        draw_list = IM_NEW(imgui_draw_list)(&g.DrawListSharedData);
        draw_list->_OwnerName = drawlist_name;
        viewport->DrawLists[drawlist_no] = draw_list;
    }

    // Our imgui_draw_list system requires that there is always a command
...
imgui_draw_list* GUI::GetBackgroundDrawList(imgui_viewport* viewport)
{
    return GetViewportDrawList((imgui_viewportP*)viewport, 0, "##Background");
}

imgui_draw_list* GUI::GetBackgroundDrawList()
{
    ImGuiWindow* window = GImGui->CurrentWindow;
    return GetBackgroundDrawList(window->Viewport);
}

imgui_draw_list* GUI::GetForegroundDrawList(imgui_viewport* viewport)
{
    return GetViewportDrawList((imgui_viewportP*)viewport, 1, "##Foreground");
}

imgui_draw_list* GUI::GetForegroundDrawList()
{
    ImGuiWindow* window = GImGui->CurrentWindow;
    return GetForegroundDrawList(window->Viewport);
}

imgui_draw_list_shared_data* GUI::GetDrawListSharedData()
{
...
void GUI::StartMouseMovingWindowOrNode(ImGuiWindow* window, ImGuiDockNode* node, bool undock_floating_node)
{
    ImGuiContext& g = *GImGui;
...
void GUI::UpdateMouseMovingWindowNewFrame()
{
    ...
    if (g.MovingWindow != NULL)
    {
        ...
        else
        {
            ...
            moving_window->Viewport->Flags &= ~imgui_viewportFlags_NoInputs;
...
void GUI::NewFrame()
{
    ...
    g.DrawListSharedData.InitialFlags = imgui_draw_listFlags_None;
    if (g.Style.AntiAliasedLines)
        g.DrawListSharedData.InitialFlags |= imgui_draw_listFlags_AntiAliasedLines;
    if (g.Style.AntiAliasedLinesUseTex && !(g.Font->ContainerAtlas->Flags & ImFontAtlasFlags_NoBakedLines))
        g.DrawListSharedData.InitialFlags |= imgui_draw_listFlags_AntiAliasedLinesUseTex;
    if (g.Style.AntiAliasedFill)
        g.DrawListSharedData.InitialFlags |= imgui_draw_listFlags_AntiAliasedFill;
    if (g.IO.BackendFlags & ImGuiBackendFlags_RendererHasVtxOffset)
        g.DrawListSharedData.InitialFlags |= imgui_draw_listFlags_AllowVtxOffset;
    ...
    g.MouseCursor = imgui_mouse_cursor_Arrow;
...
void GUI::UpdateDebugToolItemPicker()
{
    ...
    if (g.DebugItemPickerActive)
    {
        ...
        GUI::SetMouseCursor(imgui_mouse_cursor_Hand);
...
static void AddDrawListToDrawData(ImVector<imgui_draw_list*>* out_list, imgui_draw_list* draw_list)
{
    ...
    if (!(draw_list->Flags & imgui_draw_listFlags_AllowVtxOffset))
        IM_ASSERT((int)draw_list->_VtxCurrentIdx == draw_list->VtxBuffer.Size);

    // Check that draw_list doesn't use more vertices than indexable (default ImDrawIdx = unsigned short = 2 bytes = 64K vertices per imgui_draw_list = per window)
    // If this assert triggers because you are drawing lots of stuff manually:
    // - First, make sure you are coarse clipping yourself and not trying to draw many things outside visible bounds.
    //   Be mindful that the imgui_draw_list API doesn't filter vertices. Use the Metrics window to inspect draw list contents.
    // - If you want large meshes with more than 64K vertices, you can either:
    //   (A) Handle the imgui_draw_cmd::VtxOffset value in your renderer back-end, and set 'io.BackendFlags |= ImGuiBackendFlags_RendererHasVtxOffset'.
    ...
    if (sizeof(ImDrawIdx) == 2)
        IM_ASSERT(draw_list->_VtxCurrentIdx < (1 << 16) && "Too many vertices in imgui_draw_list using 16-bit indices. Read comment above");
...
void imgui_draw_dataBuilder::FlattenIntoSingleLayer()
{
    int n = Layers[0].Size;
    int size = n;
    ...
    {
        ImVector<imgui_draw_list*>& layer = Layers[layer_n];
        if (layer.empty())
            continue;
        memcpy(&Layers[0][n], &layer[0], layer.Size * sizeof(imgui_draw_list*));
        n += layer.Size;
        layer.resize(0);
    }
}

static void SetupViewportDrawData(imgui_viewportP* viewport, ImVector<imgui_draw_list*>* draw_lists)
{
    // When minimized, we report draw_data->DisplaySize as zero to be consistent with non-viewport mode,
    // and to allow applications/back-ends to easily skip rendering.
    // FIXME: Note that we however do NOT attempt to report "zero drawlist / vertices" into the imgui_draw_data structure.
    // This is because the work has been done already, and its wasted! We should fix that and add optimizations for
    // it earlier in the pipeline, rather than pretend to hide the data at the end of the pipeline.
    const bool is_minimized = (viewport->Flags & imgui_viewportFlags_Minimized) != 0;

    imgui_draw_data* draw_data = &viewport->DrawDataP;
    ...
    draw_data->FramebufferScale = GUI::GetIO().DisplayFramebufferScale; // FIXME-VIEWPORT: This may vary on a per-monitor/viewport basis?
...
// Push a clipping rectangle for both ImGui logic (hit-testing etc.) and low-level imgui_draw_list rendering.
// - When using this function it is sane to ensure that float are perfectly rounded to integer values,
//   so that e.g. (int)(max.x-min.x) in user's render produce correct result.
// - If the code here changes, may need to update code of functions like NextColumn() and PushColumnClipRect():
//   some frequently called functions which to modify both channels and clipping simultaneously tend to use the
//   more specialized SetWindowClipRectBeforeSetChannel() to avoid extraneous updates of underlying imgui_draw_cmds.
...
static void GUI::EndFrameDrawDimmedBackgrounds()
{
    ImGuiContext& g = *GImGui;
    ...
    if (dim_bg_for_modal || dim_bg_for_window_list)
        ...
        {
            imgui_viewportP* viewport = g.Viewports[viewport_n];
            ...
            if (g.NavWindowingTargetAnim && viewport == g.NavWindowingTargetAnim->Viewport)
                continue;
            imgui_draw_list* draw_list = GetForegroundDrawList(viewport);
    ...
    if (dim_bg_for_window_list && g.NavWindowingTargetAnim->Active)
    {
        ...
        imgui_draw_list* draw_list = FindFrontMostVisibleChildWindow(window->RootWindow)->DrawList;
...
void GUI::Render()
{
    ...
    // Add background imgui_draw_list (for each active viewport)
    for (int n = 0; n != g.Viewports.Size; n++)
    {
        imgui_viewportP* viewport = g.Viewports[n];
    ...
    if (g.IO.MouseDrawCursor && g.MouseCursor != imgui_mouse_cursor_None)
        g.IO.Fonts->GetMouseCursoinfoTexData(g.MouseCursor, &mouse_cursor_offset, &mouse_cursor_size, &mouse_cursor_uv[0], &mouse_cursor_uv[2]);

    // Setup imgui_draw_data structures for end-user
    ...
    for (int n = 0; n < g.Viewports.Size; n++)
    {
        ...
        // Add foreground imgui_draw_list (for each active viewport)
...
static void FindHoveredWindow()
{
    ...
    imgui_viewportP* moving_window_viewport = g.MovingWindow ? g.MovingWindow->Viewport : NULL;
    if (g.MovingWindow)
...
imgui_mouse_cursor GUI::GetMouseCursor()
{
    return GImGui->MouseCursor;
}

void GUI::SetMouseCursor(imgui_mouse_cursor cursor_type)
{
...
static bool GUI::UpdateWindowManualResize(ImGuiWindow* window, const ImVec2& size_auto_fit, int* border_held, int resize_grip_count, ImU32 resize_grip_col[4], const ImRect& visibility_rect)
{
    ...
    const bool clip_with_viewport_rect = !(g.IO.BackendFlags & ImGuiBackendFlags_HasMouseHoveredViewport) || (g.IO.MouseHoveredViewport != window->ViewportId) || !(window->Viewport->Flags & imgui_viewportFlags_NoDecoration);
    ...
    for (int resize_grip_n = 0; resize_grip_n < resize_grip_count; resize_grip_n++)
    {
        ...
        if (hovered || held)
            g.MouseCursor = (resize_grip_n & 1) ? imgui_mouse_cursor_ResizeNESW : imgui_mouse_cursor_ResizeNWSE;
    ...
    for (int border_n = 0; border_n < resize_border_count; border_n++)
    {
        ...
        {
            g.MouseCursor = (border_n & 1) ? imgui_mouse_cursor_ResizeEW : imgui_mouse_cursor_ResizeNS;
            if (held)
...
void GUI::RenderWindowDecorations(ImGuiWindow* window, const ImRect& title_bar_rect, bool title_bar_is_highlight, bool handle_borders_and_resize_grips, int resize_grip_count, const ImU32 resize_grip_col[4], float resize_grip_draw_size)
{
    ImGuiContext& g = *GImGui;
    imgui_style& style = g.Style;
    ImGuiWindowFlags flags = window->Flags;
    ...
    else
    {
        ...
        if (!(flags & ImGuiWindowFlags_NoBackground))
        {
            ...
            if (g.DragDropActive && (g.FrameCount - g.DragDropAcceptFrameCount) <= 1 && g.IO.ConfigDockingTransparentPayload)
                if (g.DragDropPayload.sDataType(IMGUI_PAYLOAD_TYPE_WINDOW) && *(ImGuiWindow**)g.DragDropPayload.Data == window)
...
bool GUI::Begin(const char* name, bool* p_open, ImGuiWindowFlags flags)
{
    ...
    if (first_begin_of_the_frame)
    {
        ...
        if (window->ViewportAllowPlatformMonitorExtend >= 0 && !window->ViewportOwned && !(window->Viewport->Flags & imgui_viewportFlags_Minimized))
            if (!window->Viewport->GetMainRect().Contains(window->Rect()))
            {
                // This is based on the assumption that the DPI will be known ahead (same as the DPI of the selection done in UpdateSelectWindowViewport)
                //imgui_viewport* old_viewport = window->Viewport;
                window->Viewport = AddUpdateViewport(window, window->ID, window->Pos, window->Size, imgui_viewportFlags_NoFocusOnAppearing);
        ...
        if (window->ViewportOwned)
        {
            ...
            const imgui_viewportFlags viewport_flags_to_clear = imgui_viewportFlags_TopMost | imgui_viewportFlags_NoTaskBarIcon | imgui_viewportFlags_NoDecoration | imgui_viewportFlags_NoRendererClear;
            imgui_viewportFlags viewport_flags = window->Viewport->Flags & ~viewport_flags_to_clear;
            ...
            if (flags & ImGuiWindowFlags_Tooltip)
                viewport_flags |= imgui_viewportFlags_TopMost;
            if (g.IO.ConfigViewportsNoTaskBarIcon || is_short_lived_floating_window)
                viewport_flags |= imgui_viewportFlags_NoTaskBarIcon;
            if (g.IO.ConfigViewportsNoDecoration || is_short_lived_floating_window)
                viewport_flags |= imgui_viewportFlags_NoDecoration;
            ...
            if (is_short_lived_floating_window && (flags & ImGuiWindowFlags_Modal) == 0)
                viewport_flags |= imgui_viewportFlags_NoFocusOnAppearing | imgui_viewportFlags_NoFocusOnClick;
            ...
            if (!(flags & ImGuiWindowFlags_NoBackground))
                viewport_flags &= ~imgui_viewportFlags_NoRendererClear;
...
void GUI::SetNextWindowViewport(ImGuiID id)
{
    ImGuiContext& g = *GImGui;
...
void GUI::SetNextWindowDockID(ImGuiID id, ImGuiCond cond)
{
    ImGuiContext& g = *GImGui;
...
void GUI::SetNextWindowClass(const ImGuiWindowClass* window_class)
{
    ImGuiContext& g = *GImGui;
...
imgui_draw_list* GUI::GetWindowDrawList()
{
    ImGuiWindow* window = GetCurrentWindow();
...
imgui_viewport* GUI::GetWindowViewport()
{
    ImGuiContext& g = *GImGui;
...
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
            IM_ASSERT(g.IO.RenderDrawListsFn == NULL);  // Call GUI::Render() then pass GUI::GetDrawData() yourself to your render function!
#endif
        }
        else
        {
...
float GUI::GetWindowContentRegiowidth()
{
    ImGuiWindow* window = GImGui->CurrentWindow;
...
void GUI::BeginTooltipEx(ImGuiWindowFlags extra_flags, ImGuiTooltipFlags tooltip_flags)
{
    ...
    if (g.DragDropWithinSource || g.DragDropWithinTarget)
    {
        ...
        //PushStyleVar(imgui_styleVar_Alpha, g.Style.Alpha * 0.60f); // This would be nice but e.g ColorButton with checkboard has issue with transparent colors :(
...
bool GUI::BeginPopupModal(const char* name, bool* p_open, ImGuiWindowFlags flags)
{
    ...
    {
        imgui_viewportP* viewport = window->WasActive ? window->Viewport : (imgui_viewportP*)GetMainViewport(); // FIXME-VIEWPORT: What may be our reference viewport?
...
bool GUI::OpenPopupContextItem(const char* str_id, ImGuiPopupFlags popup_flags)
{
    ImGuiWindow* window = GImGui->CurrentWindow;
...
static bool GUI::NavScoreItem(ImGuiNavMoveResult* result, ImRect cand)
{
    ...
    if (IsMouseHoveringRect(cand.Min, cand.Max))
    {
        ...
        imgui_draw_list* draw_list = GetForegroundDrawList(window);
...
void GUI::NavMoveRequestTryWrapping(ImGuiWindow* window, ImGuiNavMoveFlags move_flags)
{
    ...
    g.Navwrap_requestWindow = window;
    g.Navwrap_requestFlags = move_flags;
}
...
static void NavRestoreLayer(ImGuiNavLayer layer)
{
    ...
    if (window->NavLastIds[layer] != 0)
        GUI::SetNavIDWithRectRel(window->NavLastIds[layer], layer, 0, g.NavWindow->NavRectRel[layer]);
    else
...
static void GUI::NavUpdate()
{
    ...
    g.Navwrap_requestWindow = NULL;
    g.Navwrap_requestFlags = ImGuiNavMoveFlags_None;
#if 0
    ...
    if (g.NavWindow)
    {
        imgui_draw_list* draw_list = GetForegroundDrawList(g.NavWindow);
...
static void GUI::NavEndFrame()
{
    ...
    ImGuiWindow* window = g.Navwrap_requestWindow;
    ImGuiNavMoveFlags move_flags = g.Navwrap_requestFlags;
...
static void GUI::NavUpdateWindowing()
{
    ...
    {
        imgui_viewport* previous_viewport = g.NavWindow ? g.NavWindow->Viewport : NULL;
        ClearActiveID();
        g.NavDisableHighlight = false;
        g.NavDisableMouseHover = true;
...
void GUI::NavUpdateWindowingOverlay()
{
    ...
    imgui_viewportP* viewport = /*g.NavWindow ? g.NavWindow->Viewport :*/ (imgui_viewportP*)GetMainViewport();
    SetNextWindowSizeConstraints(ImVec2(viewport->Size.x * 0.20f, viewport->Size.y * 0.20f), ImVec2(FLT_MAX, FLT_MAX));
    SetNextWindowPos(viewport->Pos + viewport->Size * 0.5f, ImGuiCond_Always, ImVec2(0.5f, 0.5f));
    PushStyleVar(imgui_styleVar_WindowPadding, g.Style.WindowPadding * 2.0f);
...
const ImGuiPayload* GUI::AcceptDragDropPayload(const char* type, ImGuiDragDropFlags flags)
{
    ...
    if (type != NULL && !payload.sDataType(type))
        return NULL;
...
static void WindowSettingsHandler_WriteAll(ImGuiContext* ctx, ImGuiSettingsHandler* handler, ImGuiTextBuffer* buf)
{
    ...
    for (ImGuiWindowSettings* settings = g.SettingsWindows.begin(); settings != NULL; settings = g.SettingsWindows.next_chunk(settings))
    {
        ...
        if (settings->ViewportId != 0 && settings->ViewportId != GUI::IMGUI_VIEWPORT_DEFAULT_ID)
        {
            buf->appendf("ViewportPos=%d,%d\n", settings->ViewportPos.x, settings->ViewportPos.y);
            buf->appendf("ViewportId=0x%08X\n", settings->ViewportId);
        }
        if (settings->Pos.x != 0 || settings->Pos.y != 0 || settings->ViewportId == GUI::IMGUI_VIEWPORT_DEFAULT_ID)
...
imgui_viewport* GUI::FindViewportByID(ImGuiID id)
{
    ImGuiContext& g = *GImGui;
    for (int n = 0; n < g.Viewports.Size; n++)
...
imgui_viewport* GUI::FindViewportByPlatformHandle(void* platform_handle)
{
    ImGuiContext& g = *GImGui;
    for (int i = 0; i != g.Viewports.Size; i++)
...
void GUI::SetCurrentViewport(ImGuiWindow* current_window, imgui_viewportP* viewport)
{
    ImGuiContext& g = *GImGui;
    (void)current_window;
...
static void SetWindowViewport(ImGuiWindow* window, imgui_viewportP* viewport)
{
...
static bool GUI::GetWindowAlwaysWantOwnViewport(ImGuiWindow* window)
{
    // Tooltips and menus are not automatically forced into their own viewport when the NoMerge flag is set, however the multiplication of viewports makes them more likely to protrude and create their own.
    ImGuiContext& g = *GImGui;
    if (g.IO.ConfigViewportsNoAutoMerge || (window->WindowClass.ViewportFlagsOverrideSet & imgui_viewportFlags_NoAutoMerge))
        if (g.ConfigFlagsCurrFrame & ImGuiConfigFlags_ViewportsEnable)
            if (!window->DockIsActive)
...
static bool GUI::UpdateTryMergeWindowIntoHostViewport(ImGuiWindow* window, imgui_viewportP* viewport)
{
    ImGuiContext& g = *GImGui;
    if (window->Viewport == viewport)
        return false;
    if ((viewport->Flags & imgui_viewportFlags_CanHostOtherWindows) == 0)
        return false;
    if ((viewport->Flags & imgui_viewportFlags_Minimized) != 0)
        return false;
    ...
    imgui_viewportP* old_viewport = window->Viewport;
    if (window->ViewportOwned)
        for (int n = 0; n < g.Windows.Size; n++)
...
static bool GUI::UpdateTryMergeWindowIntoHostViewports(ImGuiWindow* window)
{
    ImGuiContext& g = *GImGui;
...
void GUI::TranslateWindowsInViewport(imgui_viewportP* viewport, const ImVec2& old_pos, const ImVec2& new_pos)
{
    ImGuiContext& g = *GImGui;
    IM_ASSERT(viewport->Window == NULL && (viewport->Flags & imgui_viewportFlags_CanHostOtherWindows));
...
void GUI::ScaleWindowsInViewport(imgui_viewportP* viewport, float scale)
{
    ImGuiContext& g = *GImGui;
    if (viewport->Window)
    {
...
static imgui_viewportP* FindHoveredViewportFromWindowStack(const ImVec2 mouse_platform_pos)
{
    ...
    {
        imgui_viewportP* viewport = g.Viewports[n];
        if (!(viewport->Flags & (imgui_viewportFlags_NoInputs | imgui_viewportFlags_Minimized)) && viewport->GetMainRect().Contains(mouse_platform_pos))
...
static void GUI::UpdateViewportsNewFrame()
{
    ...
    if (viewports_enabled)
    {
        for (int n = 0; n < g.Viewports.Size; n++)
        {
            ...
            if (g.PlatformIO.Platform_GetWindowMinimized && platform_funcs_available)
            {
                ...
                if (minimized)
                    viewport->Flags |= imgui_viewportFlags_Minimized;
                else
                    viewport->Flags &= ~imgui_viewportFlags_Minimized;
            }
        }
    ...
    imgui_viewportP* main_viewport = g.Viewports[0];
    IM_ASSERT(main_viewport->ID == IMGUI_VIEWPORT_DEFAULT_ID);
    IM_ASSERT(main_viewport->Window == NULL);
    ImVec2 main_viewport_pos = viewports_enabled ? g.PlatformIO.Platform_GetWindowPos(main_viewport) : ImVec2(0.0f, 0.0f);
    ImVec2 main_viewport_size = g.IO.DisplaySize;
    if (viewports_enabled && (main_viewport->Flags & imgui_viewportFlags_Minimized))
    {
        main_viewport_pos = main_viewport->Pos;    // Preserve last pos/size when minimized (FIXME: We don't do the same for Size outside of the viewport path)
        main_viewport_size = main_viewport->Size;
    }
    AddUpdateViewport(NULL, IMGUI_VIEWPORT_DEFAULT_ID, main_viewport_pos, main_viewport_size, imgui_viewportFlags_CanHostOtherWindows);
    ...
    for (int n = 0; n < g.Viewports.Size; n++)
    {
        ...
        if ((viewport->Flags & imgui_viewportFlags_CanHostOtherWindows) && (viewport_delta_pos.x != 0.0f || viewport_delta_pos.y != 0.0f))
    ...
    // Note that 'viewport_hovered' should skip over any viewport that has the imgui_viewportFlags_NoInputs flags set.
    imgui_viewportP* viewport_hovered = NULL;
    if (g.IO.BackendFlags & ImGuiBackendFlags_HasMouseHoveredViewport)
    {
        viewport_hovered = g.IO.MouseHoveredViewport ? (imgui_viewportP*)FindViewportByID(g.IO.MouseHoveredViewport) : NULL;
        if (viewport_hovered && (viewport_hovered->Flags & imgui_viewportFlags_NoInputs))
        {
    ...
    if (is_mouse_dragging_with_an_expected_destination || g.ActiveId == 0 || !IsAnyMouseDown())
        if (viewport_hovered != NULL && viewport_hovered != g.MouseViewport && !(viewport_hovered->Flags & imgui_viewportFlags_NoInputs))
...
imgui_viewportP* GUI::AddUpdateViewport(ImGuiWindow* window, ImGuiID id, const ImVec2& pos, const ImVec2& size, imgui_viewportFlags flags)
{
    ImGuiContext& g = *GImGui;
    IM_ASSERT(id != 0);
    ...
    if (window != NULL)
    {
        if (g.MovingWindow && g.MovingWindow->RootWindow == window)
            flags |= imgui_viewportFlags_NoInputs | imgui_viewportFlags_NoFocusOnAppearing;
        if ((window->Flags & ImGuiWindowFlags_NoMouseInputs) && (window->Flags & ImGuiWindowFlags_NoNavInputs))
            flags |= imgui_viewportFlags_NoInputs;
        if (window->Flags & ImGuiWindowFlags_NoFocusOnAppearing)
            flags |= imgui_viewportFlags_NoFocusOnAppearing;
    }

    imgui_viewportP* viewport = (imgui_viewportP*)FindViewportByID(id);
    if (viewport)
    {
        if (!viewport->PlatformRequestMove)
            viewport->Pos = pos;
        if (!viewport->PlatformRequestResize)
            viewport->Size = size;
        viewport->Flags = flags | (viewport->Flags & imgui_viewportFlags_Minimized); // Preserve existing flags
    }
    else
    {
        // New viewport
        viewport = IM_NEW(imgui_viewportP)();
        viewport->ID = id;
...
static void GUI::UpdateSelectWindowViewport(ImGuiWindow* window)
{
    ImGuiContext& g = *GImGui;
    ImGuiWindowFlags flags = window->Flags;
    ...
    if ((g.NextWindowData.Flags & ImGuiNextWindowDataFlags_HasViewport) == 0)
    {
        ...
        {
            window->Viewport = (imgui_viewportP*)FindViewportByID(window->ViewportId);
            if (window->Viewport == NULL && window->ViewportPos.x != FLT_MAX && window->ViewportPos.y != FLT_MAX)
                window->Viewport = AddUpdateViewport(window, window->ID, window->ViewportPos, window->Size, imgui_viewportFlags_None);
        }
    }
    ...
    if (g.NextWindowData.Flags & ImGuiNextWindowDataFlags_HasViewport)
    {
        ...
        window->Viewport = (imgui_viewportP*)FindViewportByID(g.NextWindowData.ViewportId);
    ...
    {
        window->Viewport = AddUpdateViewport(window, window->ID, window->Pos, window->Size, imgui_viewportFlags_None);
    }
    ...
    //if (window->ViewportOwned && !(window->Viewport->Flags & imgui_viewportFlags_NoDecoration))
...
void GUI::UpdateWindows()
{
    ...
    for (int i = 1; i < g.Viewports.Size; i++)
    {
        ...
        if (is_new_platform_window)
        {
            ...
            if (g.FrameCount < 3)
                viewport->Flags |= imgui_viewportFlags_NoFocusOnAppearing;
    ...
    {
        imgui_viewportP* focused_viewport = NULL;
...
// The Render/Swap functions stored in imgui_platform_io are merely here to allow for this helper to exist, but you can do it yourself:
//
...
static int GUI::FindPlatformMonitorForPos(const ImVec2& pos)
{
    ImGuiContext& g = *GImGui;
    for (int monitor_n = 0; monitor_n < g.PlatformIO.Monitors.Size; monitor_n++)
    {
...
static int GUI::FindPlatformMonitorForRect(const ImRect& rect)
{
    ImGuiContext& g = *GImGui;
...
static void GUI::UpdateViewportPlatformMonitor(imgui_viewportP* viewport)
{
...
void GUI::DockContextInitialize(ImGuiContext* ctx)
{
    ImGuiContext& g = *ctx;
...
void GUI::DockContextShutdown(ImGuiContext* ctx)
{
...
void GUI::DockContextClearNodes(ImGuiContext* ctx, ImGuiID root_id, bool clear_settings_refs)
{
    IM_UNUSED(ctx);
...
void GUI::DockContextRebuildNodes(ImGuiContext* ctx)
{
...
void GUI::DockContextUpdateUndocking(ImGuiContext* ctx)
{
    ImGuiContext& g = *ctx;
    ImGuiDockContext* dc  = &ctx->DockContext;
    if (!(g.IO.ConfigFlags & ImGuiConfigFlags_DockingEnable))
...
#if 0
    if (GUI::IsKeyPressed(GUI::GetKeyIndex(ImGuiKey_C)))
        dc->WantFullRebuild = true;
#endif
...
// Docking context update function, called by NewFrame()
void GUI::DockContextUpdateDocking(ImGuiContext* ctx)
{
    ImGuiContext& g = *ctx;
    ImGuiDockContext* dc  = &ctx->DockContext;
    if (!(g.IO.ConfigFlags & ImGuiConfigFlags_DockingEnable))
...
static ImGuiDockNode* GUI::DockContextFindNodeByID(ImGuiContext* ctx, ImGuiID id)
{
    return (ImGuiDockNode*)ctx->DockContext.Nodes.GetVoidPtr(id);
}

ImGuiID GUI::DockContextGenNodeID(ImGuiContext* ctx)
{
...
static ImGuiDockNode* GUI::DockContextAddNode(ImGuiContext* ctx, ImGuiID id)
{
...
static void GUI::DockContextRemoveNode(ImGuiContext* ctx, ImGuiDockNode* node, bool merge_sibling_into_parent_node)
{
    ImGuiContext& g = *ctx;
    ImGuiDockContext* dc  = &ctx->DockContext;
...
static void GUI::DockContextPruneUnusedSettingsNodes(ImGuiContext* ctx)
{
    ImGuiContext& g = *ctx;
    ImGuiDockContext* dc  = &ctx->DockContext;
...
static void GUI::DockContextBuildNodesFromSettings(ImGuiContext* ctx, ImGuiDockNodeSettings* node_settings_array, int node_settings_count)
{
    // Build nodes
...
void GUI::DockContextBuildAddWindowsToNodes(ImGuiContext* ctx, ImGuiID root_id)
{
...
void GUI::DockContextQueueDock(ImGuiContext* ctx, ImGuiWindow* target, ImGuiDockNode* target_node, ImGuiWindow* payload, ImGuiDir split_dir, float split_ratio, bool split_outer)
{
...
void GUI::DockContextQueueUndockWindow(ImGuiContext* ctx, ImGuiWindow* window)
{
    ImGuiDockRequest req;
...
void GUI::DockContextQueueUndockNode(ImGuiContext* ctx, ImGuiDockNode* node)
{
    ImGuiDockRequest req;
    req.Type = ImGuiDockRequestType_Undock;
...
void GUI::DockContextQueueNotifyRemovedNode(ImGuiContext* ctx, ImGuiDockNode* node)
{
    ImGuiDockContext* dc  = &ctx->DockContext;
    for (int n = 0; n < dc->Requests.Size; n++)
...
void GUI::DockContextProcessDock(ImGuiContext* ctx, ImGuiDockRequest* req)
{
...
void GUI::DockContextProcessUndockWindow(ImGuiContext* ctx, ImGuiWindow* window, bool clear_persistent_docking_ref)
{
...
void GUI::DockContextProcessUndockNode(ImGuiContext* ctx, ImGuiDockNode* node)
{
...
bool GUI::DockContextCalcDropPosForDocking(ImGuiWindow* target, ImGuiDockNode* target_node, ImGuiWindow* payload, ImGuiDir split_dir, bool split_outer, ImVec2* out_pos)
{
    if (split_outer)
    {
        IM_ASSERT(0);
...
int GUI::DockNodeGetTabOrder(ImGuiWindow* window)
{
...
static void GUI::DockNodeAddWindow(ImGuiDockNode* node, ImGuiWindow* window, bool add_to_tab_bar)
{
...
static void GUI::DockNodeRemoveWindow(ImGuiDockNode* node, ImGuiWindow* window, ImGuiID save_dock_id)
{
    ImGuiContext& g = *GImGui;
...
static void GUI::DockNodeMoveChildNodes(ImGuiDockNode* dst_node, ImGuiDockNode* src_node)
{
...
static void GUI::DockNodeMoveWindows(ImGuiDockNode* dst_node, ImGuiDockNode* src_node)
{
...
static void GUI::DockNodeApplyPosSizeToWindows(ImGuiDockNode* node)
{
    for (int n = 0; n < node->Windows.Size; n++)
    {
...
static void GUI::DockNodeHideHostWindow(ImGuiDockNode* node)
{
    if (node->HostWindow)
    {
...
static ImGuiWindow* GUI::DockNodeFindWindowByID(ImGuiDockNode* node, ImGuiID id)
{
    IM_ASSERT(id != 0);
    for (int n = 0; n < node->Windows.Size; n++)
...
static void GUI::DockNodeUpdateVisibleFlagAndInactiveChilds(ImGuiDockNode* node)
{
    ImGuiContext& g = *GImGui;
...
static void GUI::DockNodeUpdateVisibleFlag(ImGuiDockNode* node)
{
    // Update visibility flag
...
static void GUI::DockNodeStartMouseMovingWindow(ImGuiDockNode* node, ImGuiWindow* window)
{
    ImGuiContext& g = *GImGui;
...
static void GUI::DockNodeUpdateForRootNode(ImGuiDockNode* node)
{
...
static void GUI::DockNodeUpdate(ImGuiDockNode* node)
{
    ImGuiContext& g = *GImGui;
    ...
    else
    {
        ...
        if (node->IsRootNode() && node->IsVisible)
        {
            ...
            PushStyleVar(imgui_styleVar_WindowPadding, ImVec2(0, 0));
    ...
    if (central_node_hole)
        if (const ImGuiPayload* payload = GUI::GetDragDropPayload())
            if (payload->sDataType(IMGUI_PAYLOAD_TYPE_WINDOW) && DockNodeIsDropAllowed(host_window, *(ImGuiWindow**)payload->Data))
...
static ImGuiID GUI::DockNodeUpdateWindowMenu(ImGuiDockNode* node, ImGuiTabBar* tab_bar)
{
...
static void GUI::DockNodeUpdateTabBar(ImGuiDockNode* node, ImGuiWindow* host_window)
{
    ImGuiContext& g = *GImGui;
    imgui_style& style = g.Style;
    ...
    // Begin tab bar
    ImGuiTabBarFlags tab_bar_flags = ImGuiTabBarFlags_Reorderable | ImGuiTabBarFlags_AutoSelectnew_oneabs; // | ImGuiTabBarFlags_NoTabListScrollingButtons);
...
static void GUI::DockNodeAddTabBar(ImGuiDockNode* node)
{
    IM_ASSERT(node->TabBar == NULL);
    node->TabBar = IM_NEW(ImGuiTabBar);
}

static void GUI::DockNodeRemoveTabBar(ImGuiDockNode* node)
{
    if (node->TabBar == NULL)
        return;
...
static bool GUI::DockNodeIsDropAllowed(ImGuiWindow* host_window, ImGuiWindow* root_payload)
{
...
static void GUI::DockNodeCalcTabBarLayout(const ImGuiDockNode* node, ImRect* out_title_rect, ImRect* out_tab_bar_rect, ImVec2* out_window_menu_button_pos)
{
    ImGuiContext& g = *GImGui;
...
void GUI::DockNodeCalcSplitRects(ImVec2& pos_old, ImVec2& size_old, ImVec2& pos_new, ImVec2& size_new, ImGuiDir dir, ImVec2 size_new_desired)
{
    ImGuiContext& g = *GImGui;
...
bool GUI::DockNodeCalcDropRectsAndTestMousePos(const ImRect& parent, ImGuiDir dir, ImRect& out_r, bool outer_docking, ImVec2* test_mouse_pos)
{
    ImGuiContext& g = *GImGui;
...
static void GUI::DockNodePreviewDockSetup(ImGuiWindow* host_window, ImGuiDockNode* host_node, ImGuiWindow* root_payload, ImGuiDockPreviewData* data, bool is_explicit_target, bool is_outer_docking)
{
    ImGuiContext& g = *GImGui;
...
static void GUI::DockNodePreviewDockRender(ImGuiWindow* host_window, ImGuiDockNode* host_node, ImGuiWindow* root_payload, const ImGuiDockPreviewData* data)
{
    ImGuiContext& g = *GImGui;
    ...
    imgui_draw_list* overlay_draw_lists[2];
    ...
    if (data->IsDropAllowed && can_preview_tabs && data->SplitDir == ImGuiDir_None && data->IsCenterAvailable)
    {
        ...
        if (host_node && host_node->TabBar)
        {
            if (!host_node->IsHiddenTabBar() && !host_node->IsNoTabBar())
                tab_pos.x += host_node->TabBar->OffsetMax + g.Style.ItemInnerSpacing.x; // We don't use Offsetnew_oneab because when using non-persistent-order tab bar it is incremented with each Tab submission.
            else
...
void GUI::DockNodeTreeSplit(ImGuiContext* ctx, ImGuiDockNode* parent_node, ImGuiAxis split_axis, int split_inheritor_child_idx, float split_ratio, ImGuiDockNode* new_node)
{
    ImGuiContext& g = *GImGui;
...
void GUI::DockNodeTreeMerge(ImGuiContext* ctx, ImGuiDockNode* parent_node, ImGuiDockNode* merge_lead_child)
{
...
void GUI::DockNodeTreeUpdatePosSize(ImGuiDockNode* node, ImVec2 pos, ImVec2 size, bool only_write_to_marked_nodes)
{
...
void GUI::DockNodeTreeUpdateSplitter(ImGuiDockNode* node)
{
    if (node->IsLeafNode())
        return;
    ...
    if (child_0->IsVisible && child_1->IsVisible)
    {
        ...
        else
        {
            ...
            if (g.ActiveId == splitter_id)
            {
                ...
                /*
                // [DEBUG] Render limits
                imgui_draw_list* draw_list = node->HostWindow ? GetForegroundDrawList(node->HostWindow) : GetForegroundDrawList((imgui_viewportP*)GetMainViewport());
                for (int n = 0; n < 2; n++)
                    if (axis == ImGuiAxis_X)
...
ImGuiDockNode* GUI::DockNodeTreeFindFallbackLeafNode(ImGuiDockNode* node)
{
    if (node->IsLeafNode())
        return node;
...
ImGuiDockNode* GUI::DockNodeTreeFindVisibleNodeByPos(ImGuiDockNode* node, ImVec2 pos)
{
    if (!node->IsVisible)
        return NULL;
...
void GUI::SetWindowDock(ImGuiWindow* window, ImGuiID dock_id, ImGuiCond cond)
{
    // Test condition (NB: bit 0 is always true) and clear flags for next time
...
void GUI::DockSpace(ImGuiID id, const ImVec2& size_arg, ImGuiDockNodeFlags flags, const ImGuiWindowClass* window_class)
{
    ImGuiContext* ctx = GImGui;
    ImGuiContext& g = *ctx;
    ImGuiWindow* window = GetCurrentWindow();
    ...
    PushStyleVar(imgui_styleVar_ChildBorderSize, 0.0f);
...
ImGuiID GUI::DockSpaceOverViewport(imgui_viewport* viewport, ImGuiDockNodeFlags dockspace_flags, const ImGuiWindowClass* window_class)
{
    if (viewport == NULL)
    ...
    PushStyleVar(imgui_styleVar_WindowBorderSize, 0.0f);
    PushStyleVar(imgui_styleVar_WindowPadding, ImVec2(0.0f, 0.0f));
...
void GUI::DockBuilderDockWindow(const char* window_name, ImGuiID node_id)
{
...
ImGuiDockNode* GUI::DockBuilderGetNode(ImGuiID node_id)
{
    ImGuiContext* ctx = GImGui;
    return DockContextFindNodeByID(ctx, node_id);
}

void GUI::DockBuilderSetNodePos(ImGuiID node_id, ImVec2 pos)
{
    ImGuiContext* ctx = GImGui;
...
void GUI::DockBuilderSetNodeSize(ImGuiID node_id, ImVec2 size)
{
    ImGuiContext* ctx = GImGui;
    ImGuiDockNode* node = DockContextFindNodeByID(ctx, node_id);
    if (node == NULL)
...
ImGuiID GUI::DockBuilderAddNode(ImGuiID id, ImGuiDockNodeFlags flags)
{
    ImGuiContext* ctx = GImGui;
...
void GUI::DockBuilderRemoveNode(ImGuiID node_id)
{
    ImGuiContext* ctx = GImGui;
    ImGuiDockNode* node = DockContextFindNodeByID(ctx, node_id);
    if (node == NULL)
...
void GUI::DockBuilderRemoveNodeChildNodes(ImGuiID root_id)
{
    ImGuiContext* ctx = GImGui;
    ImGuiDockContext* dc  = &ctx->DockContext;
...
void GUI::DockBuilderRemoveNodeDockedWindows(ImGuiID root_id, bool clear_settings_refs)
{
...
ImGuiID GUI::DockBuilderSplitNode(ImGuiID id, ImGuiDir split_dir, float size_ratio_for_node_at_dir, ImGuiID* out_id_at_dir, ImGuiID* out_id_at_opposite_dir)
{
    ImGuiContext* ctx = GImGui;
...
{
    ImGuiContext* ctx = GImGui;
    ImGuiDockNode* dst_node = GUI::DockContextAddNode(ctx, dst_node_id_if_known);
...
void GUI::DockBuilderCopyNode(ImGuiID src_node_id, ImGuiID dst_node_id, ImVector<ImGuiID>* out_node_remap_pairs)
{
    ImGuiContext* ctx = GImGui;
...
void GUI::DockBuilderCopyWindowSettings(const char* src_name, const char* dst_name)
{
...
void GUI::DockBuilderCopyDockSpace(ImGuiID src_dockspace_id, ImGuiID dst_dockspace_id, ImVector<const char*>* in_window_remap_pairs)
{
...
void GUI::DockBuilderFinish(ImGuiID root_id)
{
    ImGuiContext* ctx = GImGui;
...
bool GUI::GetWindowAlwaysWantOwnTabBar(ImGuiWindow* window)
{
    ImGuiContext& g = *GImGui;
...
static ImGuiDockNode* GUI::DockContextBindNodeToWindow(ImGuiContext* ctx, ImGuiWindow* window)
{
    ImGuiContext& g = *ctx;
    ImGuiDockNode* node = DockContextFindNodeByID(ctx, window->DockId);
    IM_ASSERT(window->DockNode == NULL);
...
void GUI::BeginDocked(ImGuiWindow* window, bool* p_open)
{
    ImGuiContext* ctx = GImGui;
    ImGuiContext& g = *ctx;
...
void GUI::BeginDockableDragDropSource(ImGuiWindow* window)
{
    ImGuiContext& g = *GImGui;
...
void GUI::BeginDockableDragDropTarget(ImGuiWindow* window)
{
    ImGuiContext* ctx = GImGui;
    ImGuiContext& g = *ctx;
    ...
    if (!payload->sDataType(IMGUI_PAYLOAD_TYPE_WINDOW) || !DockNodeIsDropAllowed(window, *(ImGuiWindow**)payload->Data))
    {
        EndDragDropTarget();
        return;
    }
...
static void GUI::DockSettingsRenameNodeReferences(ImGuiID old_node_id, ImGuiID new_node_id)
{
    ImGuiContext& g = *GImGui;
...
static void GUI::DockSettingsRemoveNodeReferences(ImGuiID* node_ids, int node_ids_count)
{
    ImGuiContext& g = *GImGui;
    int found = 0;
    //// FIXME-OPT: We could remove this loop by storing the index in the map
...
static ImGuiDockNodeSettings* GUI::DockSettingsFindNodeSettings(ImGuiContext* ctx, ImGuiID id)
{
    // FIXME-OPT
    ImGuiDockContext* dc  = &ctx->DockContext;
...
// Clear settings data
static void GUI::DockSettingsHandler_ClearAll(ImGuiContext* ctx, ImGuiSettingsHandler*)
{
    ImGuiDockContext* dc  = &ctx->DockContext;
...
static void GUI::DockSettingsHandler_ApplyAll(ImGuiContext* ctx, ImGuiSettingsHandler*)
{
...
static void* GUI::DockSettingsHandler_ReadOpen(ImGuiContext*, ImGuiSettingsHandler*, const char* name)
{
...
static void GUI::DockSettingsHandler_ReadLine(ImGuiContext* ctx, ImGuiSettingsHandler*, void*, const char* line)
{
    char c = 0;
    int x = 0, y = 0;
    int r = 0;
...
static void GUI::DockSettingsHandler_WriteAll(ImGuiContext* ctx, ImGuiSettingsHandler* handler, ImGuiTextBuffer* buf)
{
    ImGuiContext& g = *ctx;
    ImGuiDockContext* dc = &ctx->DockContext;
    if (!(g.IO.ConfigFlags & ImGuiConfigFlags_DockingEnable))
...
static void SetClipboardTextFn_DefaultImpl(void*, const char* text)
{
    ...
    CFDataRef cf_data = CFDataCreate(kCFAllocatorDefault, (const ui8*)text, strlen(text));
    if (cf_data)
    {
    ...
    for (ItemCount i = 0; i < item_count; i++)
    {
        ...
        for (CFIndex j = 0, nj = CFArrayGetCount(flavor_type_array); j < nj; j++)
        {
            ...
            if (PasteboardCopyItemFlavorData(main_clipboard, item_id, CFSTR("public.utf8-plain-text"), &cf_data) == noErr)
            {
                ...
                CFDataGetBytes(cf_data, CFRangeMake(0, length), (ui8*)g.ClipboardHandlerData.Data);
...
static void RenderViewportThumbnail(imgui_draw_list* draw_list, imgui_viewportP* viewport, const ImRect& bb)
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = g.CurrentWindow;
    ...
    float alpha_mul = (viewport->Flags & imgui_viewportFlags_Minimized) ? 0.30f : 1.00f;
    window->DrawList->AddRectFilled(bb.Min, bb.Max, GUI::GetColorU32(ImGuiCol_Border, alpha_mul * 0.40f));
    for (int i = 0; i != g.Windows.Size; i++)
    {
        ...
        window->DrawList->AddRectFilled(thumb_r_scaled.Min, thumb_r_scaled.Max, GUI::GetColorU32(ImGuiCol_WindowBg, alpha_mul));
        window->DrawList->AddRectFilled(title_r_scaled.Min, title_r_scaled.Max, GUI::GetColorU32(window_is_focused ? ImGuiCol_TitleBgActive : ImGuiCol_TitleBg, alpha_mul));
        window->DrawList->AddRect(thumb_r_scaled.Min, thumb_r_scaled.Max, GUI::GetColorU32(ImGuiCol_Border, alpha_mul));
        if (ImGuiWindow* window_for_title = GetWindowForTitleDisplay(thumb_window))
            window->DrawList->AddText(g.Font, g.FontSize * 1.0f, title_r_scaled.Min, GUI::GetColorU32(ImGuiCol_Text, alpha_mul), window_for_title->Name, GUI::FindRenderedTextEnd(window_for_title->Name));
    }
    draw_list->AddRect(bb.Min, bb.Max, GUI::GetColorU32(ImGuiCol_Border, alpha_mul));
}

void GUI::ShowViewportThumbnails()
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = g.CurrentWindow;
    ...
    //for (int n = 0; n < g.PlatformIO.Monitors.Size; n++)
    //    window->DrawList->AddRect(off + g.PlatformIO.Monitors[n].MainPos * SCALE, off + (g.PlatformIO.Monitors[n].MainPos + g.PlatformIO.Monitors[n].MainSize) * SCALE, GUI::GetColorU32(ImGuiCol_Border));
    for (int n = 0; n < g.Viewports.Size; n++)
    {
        imgui_viewportP* viewport = g.Viewports[n];
...
void GUI::ShowMetricsWindow(bool* p_open)
{
    ...
    struct Funcs
    {
        ...
        static void NodeDrawCmdShowMeshAndBoundingBox(imgui_draw_list* fg_draw_list, const imgui_draw_list* draw_list, const imgui_draw_cmd* draw_cmd, int elem_offset, bool show_mesh, bool show_aabb)
        {
            ...
            imgui_draw_listFlags backup_flags = fg_draw_list->Flags;
            fg_draw_list->Flags &= ~imgui_draw_listFlags_AntiAliasedLines; // Disable AA on triangle outlines is more readable for very large and thin triangles.
        ...
        static void NodeDrawList(ImGuiWindow* window, imgui_viewportP* viewport, imgui_draw_list* draw_list, const char* label)
        {
            ...
            imgui_draw_list* fg_draw_list = viewport ? GetForegroundDrawList(viewport) : NULL; // Render additional visuals into the top-most draw list
            if (window && fg_draw_list && GUI::IsItemHovered())
            ...
            for (const imgui_draw_cmd* pcmd = draw_list->CmdBuffer.begin(); pcmd < draw_list->CmdBuffer.end(); elem_offset += pcmd->ElemCount, pcmd++)
            {
        ...
        static void NodeWindows(ImVector<ImGuiWindow*>& windows, const char* label)
        {
            if (!GUI::TreeNode(label, "%s (%d)", label, windows.Size))
                return;
            GUI::Text("(In front-to-back order:)");
        ...
        static void NodeWindow(ImGuiWindow* window, const char* label)
        {
            ...
            const bool open = GUI::TreeNodeEx(label, tree_node_flags, "%s '%s'%s", label, window->Name, is_active ? "" : " *Inactive*");
            if (!is_active) { PopStyleColor(); }
            if (GUI::IsItemHovered() && is_active)
                GUI::GetForegroundDrawList(window)->AddRect(window->Pos, window->Pos + window->Size, IM_COL32(255, 255, 0, 255));
            if (!open)
                return;
            ...
            GUI::BulletText("WindowClassId: 0x%08X", window->WindowClass.ClassId);
            ...
            GUI::BulletText("Viewport: %d%s, ViewportId: 0x%08X, ViewportPos: (%.1f,%.1f)", window->Viewport ? window->Viewport->Idx : -1, window->ViewportOwned ? " (Owned)" : "", window->ViewportId, window->ViewportPos.x, window->ViewportPos.y);
            GUI::BulletText("ViewportMonitor: %d", window->Viewport ? window->Viewport->PlatformMonitor : -1);
            GUI::BulletText("DockId: 0x%04X, DockOrder: %d, Act: %d, Vis: %d", window->DockId, window->DockOrder, window->DockIsActive, window->DockTabIsVisible);
        ...
        static void NodeViewport(imgui_viewportP* viewport)
        {
            GUI::SetNextItemOpen(true, ImGuiCond_Once);
            if (GUI::TreeNode((void*)(intptr_t)viewport->ID, "Viewport #%d, ID: 0x%08X, Parent: 0x%08X, Window: \"%s\"", viewport->Idx, viewport->ID, viewport->ParentViewportId, viewport->Window ? viewport->Window->Name : "N/A"))
            {
                ImGuiWindowFlags flags = viewport->Flags;
                GUI::BulletText("Main Pos: (%.0f,%.0f), Size: (%.0f,%.0f)\nWorkArea Offset Left: %.0f Top: %.0f, Right: %.0f, Bottom: %.0f\nMonitor: %d, DpiScale: %.0f%%",
                    viewport->Pos.x, viewport->Pos.y, viewport->Size.x, viewport->Size.y,
                    viewport->WorkOffsetMin.x, viewport->WorkOffsetMin.y, viewport->WorkOffsetMax.x, viewport->WorkOffsetMax.y,
                    viewport->PlatformMonitor, viewport->DpiScale * 100.0f);
                if (viewport->Idx > 0) { GUI::SameLine(); if (GUI::SmallButton("Reset Pos")) { viewport->Pos = ImVec2(200,200); if (viewport->Window) viewport->Window->Pos = ImVec2(200,200); } }
                GUI::BulletText("Flags: 0x%04X =%s%s%s%s%s%s%s", viewport->Flags,
                    (flags & imgui_viewportFlags_CanHostOtherWindows) ? " CanHostOtherWindows" : "", (flags & imgui_viewportFlags_NoDecoration) ? " NoDecoration" : "",
                    (flags & imgui_viewportFlags_NoFocusOnAppearing)  ? " NoFocusOnAppearing"  : "", (flags & imgui_viewportFlags_NoInputs)     ? " NoInputs"     : "",
                    (flags & imgui_viewportFlags_NoRendererClear)     ? " NoRendererClear"     : "", (flags & imgui_viewportFlags_Minimized)    ? " Minimized"    : "",
                    (flags & imgui_viewportFlags_NoAutoMerge)         ? " NoAutoMerge"         : "");
        ...
        static void NodeDockNode(ImGuiDockNode* node, const char* label)
        {
            ...
            bool open;
            if (node->Windows.Size > 0)
                open = GUI::TreeNode((void*)(intptr_t)node->ID, "%s 0x%04X%s: %d windows (vis: '%s')", label, node->ID, node->IsVisible ? "" : " (hidden)", node->Windows.Size, node->VisibleWindow ? node->VisibleWindow->Name : "NULL");
            else
                open = GUI::TreeNode((void*)(intptr_t)node->ID, "%s 0x%04X%s: %s split (vis: '%s')", label, node->ID, node->IsVisible ? "" : " (hidden)", (node->SplitAxis == ImGuiAxis_X) ? "horizontal" : (node->SplitAxis == ImGuiAxis_Y) ? "vertical" : "n/a", node->VisibleWindow ? node->VisibleWindow->Name : "NULL");
            if (!is_alive) { PopStyleColor(); }
            if (is_active && GUI::IsItemHovered())
            ...
            if (open)
            {
                ...
                GUI::BulletText("Pos (%.0f,%.0f), Size (%.0f, %.0f) Ref (%.0f, %.0f)",
                    node->Pos.x, node->Pos.y, node->Size.x, node->Size.y, node->SizeRef.x, node->SizeRef.y);
                NodeWindow(node->HostWindow, "HostWindow");
                NodeWindow(node->VisibleWindow, "VisibleWindow");
                GUI::BulletText("SelectedTabID: 0x%08X, LastFocusedNodeID: 0x%08X", node->SelectedTabId, node->LastFocusedNodeId);
                GUI::BulletText("Misc:%s%s%s%s%s",
                    node->IsDockSpace() ? " IsDockSpace" : "",
                    node->IsCentralNode() ? " IsCentralNode" : "",
                    is_alive ? " IsAlive" : "", is_active ? " IsActive" : "",
                    node->WantLockSizeOnce ? " WantLockSizeOnce" : "");
                if (GUI::TreeNode("flags", "LocalFlags: 0x%04X SharedFlags: 0x%04X", node->LocalFlags, node->SharedFlags))
                {
                    GUI::CheckboxFlags("LocalFlags: NoDocking", (ImU32*)&node->LocalFlags, ImGuiDockNodeFlags_NoDocking);
                    GUI::CheckboxFlags("LocalFlags: NoSplit", (ImU32*)&node->LocalFlags, ImGuiDockNodeFlags_NoSplit);
                    GUI::CheckboxFlags("LocalFlags: NoResize", (ImU32*)&node->LocalFlags, ImGuiDockNodeFlags_NoResize);
                    GUI::CheckboxFlags("LocalFlags: NoResizeX", (ImU32*)&node->LocalFlags, ImGuiDockNodeFlags_NoResizeX);
                    GUI::CheckboxFlags("LocalFlags: NoResizeY", (ImU32*)&node->LocalFlags, ImGuiDockNodeFlags_NoResizeY);
                    GUI::CheckboxFlags("LocalFlags: NoTabBar", (ImU32*)&node->LocalFlags, ImGuiDockNodeFlags_NoTabBar);
                    GUI::CheckboxFlags("LocalFlags: HiddenTabBar", (ImU32*)&node->LocalFlags, ImGuiDockNodeFlags_HiddenTabBar);
                    GUI::CheckboxFlags("LocalFlags: NoWindowMenuButton", (ImU32*)&node->LocalFlags, ImGuiDockNodeFlags_NoWindowMenuButton);
                    GUI::CheckboxFlags("LocalFlags: NoCloseButton", (ImU32*)&node->LocalFlags, ImGuiDockNodeFlags_NoCloseButton);
                    GUI::TreePop();
                }
                if (node->ParentNode)
        ...
        static void NodeTabBar(ImGuiTabBar* tab_bar)
        {
            ...
            const bool is_active = (tab_bar->PrevFrameVisible >= GUI::GetFrameCount() - 2);
            ...
            if (!is_active) { PushStyleColor(ImGuiCol_Text, GetStyleColorVec4(ImGuiCol_TextDisabled)); }
            bool open = GUI::TreeNode(tab_bar, "%s", buf);
            if (!is_active) { PopStyleColor(); }
            if (open)
            {
                for (int tab_n = 0; tab_n < tab_bar->Tabs.Size; tab_n++)
                {
                    ...
                    GUI::Text("%02d%c Tab 0x%08X '%s'", tab_n, (tab->ID == tab_bar->SelectedTabId) ? '*' : ' ', tab->ID, (tab->Window || tab->NameOffset != -1) ? tab_bar->GetTabName(tab) : "");
                    GUI::PopID();
                }
                GUI::TreePop();
            }
    ...
    if (GUI::TreeNode("Tools"))
    {
        ...
        GUI::Checkbox("Show mesh when hovering imgui_draw_cmd", &show_drawcmd_mesh);
        GUI::Checkbox("Show bounding boxes when hovering imgui_draw_cmd", &show_drawcmd_aabb);
        GUI::TreePop();
    }
    ...
    if (GUI::TreeNode("Viewport", "Viewports (%d)", g.Viewports.Size))
    {
        GUI::Indent(GUI::GetTreeNodeToLabelSpacing());
        GUI::ShowViewportThumbnails();
        GUI::Unindent(GUI::GetTreeNodeToLabelSpacing());
        bool open = GUI::TreeNode("Monitors", "Monitors (%d)", g.PlatformIO.Monitors.Size);
        GUI::SameLine();
        ...
        if (open)
        {
            for (int i = 0; i < g.PlatformIO.Monitors.Size; i++)
            {
                ...
                GUI::BulletText("Monitor #%d: DPI %.0f%%\n MainMin (%.0f,%.0f), MainMax (%.0f,%.0f), MainSize (%.0f,%.0f)\n WorkMin (%.0f,%.0f), WorkMax (%.0f,%.0f), WorkSize (%.0f,%.0f)",
    ...
    // Details for Docking
#ifdef IMGUI_HAS_DOCK
    if (GUI::TreeNode("Dock nodes"))
    {
        static bool root_nodes_only = true;
        ImGuiDockContext* dc = &g.DockContext;
        GUI::Checkbox("List root nodes", &root_nodes_only);
        GUI::Checkbox("Ctrl shows window dock info", &show_docking_nodes);
        if (GUI::SmallButton("Clear nodes")) { DockContextClearNodes(&g, 0, true); }
        GUI::SameLine();
        if (GUI::SmallButton("Rebuild all")) { dc->WantFullRebuild = true; }
        for (int n = 0; n < dc->Nodes.Data.Size; n++)
            if (ImGuiDockNode* node = (ImGuiDockNode*)dc->Nodes.Data[n].val_p)
    ...
    if (GUI::TreeNode("Settings"))
    {
        ...
        GUI::SameLine();
        if (GUI::SmallButton("Save to memory"))
        ...
        if (GUI::TreeNode("SettingsHandlers", "Settings handlers: (%d)", g.SettingsHandlers.Size))
        {
            for (int n = 0; n < g.SettingsHandlers.Size; n++)
                GUI::BulletText("%s", g.SettingsHandlers[n].TypeName);
            GUI::TreePop();
        }
...
#ifdef IMGUI_HAS_DOCK
        if (GUI::TreeNode("SettingsDocking", "Settings packed data: Docking"))
        {
            ImGuiDockContext* dc = &g.DockContext;
            GUI::Text("In SettingsWindows:");
            for (ImGuiWindowSettings* settings = g.SettingsWindows.begin(); settings != NULL; settings = g.SettingsWindows.next_chunk(settings))
                if (settings->DockId != 0)
                    GUI::BulletText("Window '%s' -> DockId %08X", settings->GetName(), settings->DockId);
            GUI::Text("In SettingsNodes:");
            for (int n = 0; n < dc->NodesSettings.Size; n++)
            {
                ...
                GUI::BulletText("Node %08X, Parent %08X, SelectedTab %08X ('%s')", settings->ID, settings->ParentNodeId, settings->SelectedWindowId, selected_tab_name ? selected_tab_name : settings->SelectedWindowId ? "N/A" : "");
            }
            GUI::TreePop();
        }
#endif // #ifdef IMGUI_HAS_DOCK
        ...
        {
            GUI::InputTextMultiline("##Ini", (char*)(void*)g.SettingsIniData.c_str(), g.SettingsIniData.Buf.Size, ImVec2(-FLT_MIN, 0.0f), ImGuiInputTextFlags_ReadOnly);
            GUI::TreePop();
        }
        GUI::TreePop();
    }
    ...
    if (GUI::TreeNode("Internal state"))
    {
        ...
        GUI::Text("HoveredWindowUnderMovingWindow: '%s'", g.HoveredWindowUnderMovingWindow ? g.HoveredWindowUnderMovingWindow->Name : "NULL");
        GUI::Text("HoveredDockNode: 0x%08X", g.HoveredDockNode ? g.HoveredDockNode->ID : 0);
        GUI::Text("MovingWindow: '%s'", g.MovingWindow ? g.MovingWindow->Name : "NULL");
        GUI::Text("MouseViewport: 0x%08X (UserHovered 0x%08X, LastHovered 0x%08X)", g.MouseViewport->ID, g.IO.MouseHoveredViewport, g.MouseLastHoveredViewport ? g.MouseLastHoveredViewport->ID : 0);
        GUI::Unindent();
        ...
        GUI::Text("NavFocusScopeId = 0x%08X", g.NavFocusScopeId);
    ...
    if (show_docking_nodes && g.IO.KeyCtrl && g.HoveredDockNode)
    {
        ...
        imgui_draw_list* overlay_draw_list = node->HostWindow ? GetForegroundDrawList(node->HostWindow) : GetForegroundDrawList((imgui_viewportP*)GetMainViewport());
